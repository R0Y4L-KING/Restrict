...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8786268348:AAHZ2J4Jxc8auCjboGaIkaRNvh_YZ1Qd2ss")
API_ID = int(os.environ.get("API_ID", "29780235"))
...
ADMINS = [int(admin) for admin in os.environ.get("ADMINS", "6275020364").split(",") if admin]
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://Restrict:hk199236@restrict.oakmtpd.mongodb.net/?appName=Restrict")
DB_NAME = os.environ.get("DB_NAME", "Restrict")
...
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003675100602"))
